...
void CVertexDraw::createVertex()
{
	...
	//g_pDevice->CreateVertexBuffer( sizeof( vertices), 0, D3DFVF_CUSTOMVERTEX, D3DPOOL_DEFAULT, &pVeretxBuffer, NULL);//创建顶点buff
	//void* pVertices = NULL;
	...
	//hr = g_pDevice->SetFVF( D3DFVF_CUSTOMVERTEX);//设置顶点格式
